...
class Running extends Workout {
    ...
    calcPace(){
        //min/km
        this.pace = Number(this.duration)/Number(this.distance);
        return this.pace;
    }
}
...
class Cycling extends Workout {
    ...
    calcSpeed(){
        //km/h
        this.speed = Number(this.distance)/(Number(this.duration)/60);
        return this.speed;
    }
    
}

// const run1 = new Running([39, -12], 4, 22, 150);
// const cyclist1 = new Cycling([37,-12],27, 95, 523)

// console.log(run1,cyclist1);

/////////////////////////////////////////////////////////////////////
//Aplication Acrchitecture
...
class App{
    ...
    _newWorkout(e){
        ...
        e.preventDefault();
            ...
            //Add nre object to workout array
